        ...
        builder: (context, snapshot) {
          ...
          return RefreshIndicator(
            ...
            child: ListView(
              ...
              children: [
                Text('${snapshot.data!.length} books in your collection',
                ...
                SearchBar(
                  ...
                  trailing: [
                    IconButton(
                      ...
                      tooltip:
                          alphabetical ? 'Sort by recently added' : 'Sort A–Z',
                      onPressed: () =>
                    ...
                    children: [
                      Text('Your books',
                          style: Theme.of(context)
                              ...
                              .titleMedium
                              ?.copyWith(fontWeight: FontWeight.w600)),
                      Text(alphabetical ? 'A–Z' : 'Recently added',
                          style: Theme.of(context).textTheme.bodySmall),
                    ]),
...
class _StatusChip extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final label = switch (book.status) {
      ...
      BookStatus.borrowed =>
        'Borrowed${book.borrowedBy == null ? '' : ' · ${book.borrowedBy}'}',
        ...
        body: ListView(padding: const EdgeInsets.all(20), children: [
          FilledButton.icon(
            onPressed: () => ScaffoldMessenger.of(context).showSnackBar(
                const SnackBar(
                    content: Text(
                        'Scanner integration is the next implementation step.'))),
            ...
            child: Column(children: [
              ...
              TextFormField(
                  ...
                  decoration: const InputDecoration(
                      labelText: 'ISBN or barcode (optional)')),
              const SizedBox(height: 14),
              DropdownButtonFormField<String>(
                  value: condition,
                  decoration: const InputDecoration(labelText: 'Condition'),
                  items: const ['New', 'Good', 'Worn']
                      .map((value) =>
              ...
              SizedBox(
                  ...
                  child: FilledButton(
                      ...
                      child: Padding(
                          ...
                          child: Text(saving ? 'Saving…' : 'Save book')))),
            ]),
          ),
        ]),
      );
...
class _BookDetailsScreenState extends State<BookDetailsScreen> {
  ...
  Widget build(BuildContext context) => Scaffold(
        ...
        body: ListView(padding: const EdgeInsets.all(20), children: [
          Center(
              child: Container(
                  ...
                  child: Text(book.title,
                      textAlign: TextAlign.center,
                      style:
                          const TextStyle(fontFamily: 'serif', fontSize: 19)))),
          const SizedBox(height: 18),
          Text(book.title,
              textAlign: TextAlign.center,
              style: Theme.of(context)
          ...
          const SizedBox(height: 22),
          Row(children: [
            Expanded(child: _Detail(label: 'Condition', value: book.condition)),
            const SizedBox(width: 10),
            Expanded(child: _Detail(label: 'Directory', value: book.directory))
          ]),
          const SizedBox(height: 10),
          Row(children: [
            ...
            const SizedBox(width: 10),
            Expanded(
                child: _Detail(label: 'Added', value: _date(book.createdAt)))
          ]),
          ...
          if (book.status == BookStatus.available)
            FilledButton(
                onPressed: lend,
                child: const Padding(
                    padding: EdgeInsets.all(15), child: Text('Lend this book')))
        ...
        child: Column(
            ...
            children: [
              ...
              TextField(
                  ...
                  decoration:
                      const InputDecoration(labelText: 'Borrower name')),
              const SizedBox(height: 12),
              SwitchListTile(
                  contentPadding: EdgeInsets.zero,
                  title: const Text('Give permanently'),
                  value: permanent,
              ...
              if (!permanent)
                ListTile(
                    ...
                    subtitle: Text(
                        returnDate == null ? 'Optional' : _date(returnDate!)),
...
class HistoryScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) => FutureBuilder<List<HistoryEntry>>(
        ...
        builder: (context, snapshot) => ListView(
          padding: const EdgeInsets.fromLTRB(20, 22, 20, 110),
          children: [
            Text('Every change, saved locally',
                style: Theme.of(context).textTheme.bodySmall),
            const SizedBox(height: 4),
            Text('History',
                style: Theme.of(context)
            ...
            if (!snapshot.hasData)
              ...
              const _EmptyState(message: 'No lending activity yet.')
            else
